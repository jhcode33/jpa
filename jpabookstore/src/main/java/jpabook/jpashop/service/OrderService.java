...
//    EntityManager em;
    ...
    public List<Order> findOrders(OrderSearch orderSearch) {
        List<Order> orderList = orderRepository.findByMemberNameLikeAndOrderStatus(
